...
class Robotiq85GripperTest(Node):
    def __init__(self):
        super().__init__('robotiq_85_test')
    ...
    def _timer_callback(self):
        ...
        if (2 == test_state):
            self.get_logger().info('Opening Gripper to max/3')
            for i in range(self._num_grippers):
        ...
        if (4 == test_state):
            self.get_logger().info('Opening Gripper to max/2')
            for i in range(self._num_grippers):
        ...
        if (6 == test_state):
            self.get_logger().info('Opening Gripper to max')
            for i in range(self._num_grippers):
...
def main(args=None):
    ...
    gripper_test = Robotiq85GripperTest()
